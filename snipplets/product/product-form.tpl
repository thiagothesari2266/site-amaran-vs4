...
<a 
  href="https://wa.me/5562995516090?text=Ol%C3%A1!%20Vi%20um%20produto%20no%20site%20da%20Amaran%20e%20quero%20saber%20mais.%0A{{ product.name | url_encode }}." 
  target="_blank" 
  style="
    display: inline-flex;
    align-items: center;
  ...
  onmouseout="
    ...
    this.querySelector('svg').style.fill='#25D366';"
>
  <svg xmlns="http://www.w3.org/2000/svg" fill="#25D366" width="20" height="20" viewBox="0 0 32 32" style="margin-right: 8px;">
    <path d="M16.003 2.005c-7.723 0-13.998 6.276-13.998 13.998 0 2.476.647 4.892 1.872 7.023l-1.979 7.261 7.432-1.951c1.986 1.081 4.229 1.651 6.673 1.651h.002c7.722 0 13.998-6.275 13.998-13.998s-6.276-13.984-13.998-13.984zm7.91 19.522c-.336.938-1.972 1.79-2.726 1.908-.695.104-1.547.148-2.501-.156-.576-.181-1.31-.43-2.267-.839-3.994-1.735-6.607-5.795-6.807-6.065-.199-.27-1.626-2.163-1.626-4.132 0-1.97 1.026-2.938 1.391-3.309.367-.373.799-.466 1.063-.466.264 0 .531.002.763.014.248.012.576-.093.902.686.336.81 1.145 2.803 1.247 3.005.102.199.168.434.03.701-.133.27-.201.436-.395.67-.201.23-.419.517-.598.695-.197.199-.402.416-.173.817.23.401 1.026 1.695 2.202 2.742 1.518 1.343 2.79 1.759 3.191 1.959.402.199.633.17.866-.102.23-.27.999-1.164 1.27-1.562.27-.4.536-.332.902-.199.365.133 2.307 1.089 2.701 1.287.396.199.659.297.758.463.098.164.098.954-.238 1.893z"/>
  </svg>
  Perfume ideal? A gente ajuda!
</a>
